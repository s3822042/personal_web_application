    ...
    <div className="w-full h-full">
      <div>
        <div className="w-full px-6">
          <div className="mt-8 relative rounded-lg bg-darker container mx-auto flex flex-col items-center pt-12 sm:pt-24 pb-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
            <svg
            ...
            <div className="w-11/12 sm:w-2/3 mb-5 sm:mb-10">
              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl justify-center  font-bold leading-tight flex">
                <div className="static-txt text-white">I am</div>
                <ul className="dynamic-txt ml-4">
                  <li>
                    <span>Vo Thanh Luan</span>
                  </li>
                  <li>
                    <span>Sophomore Student</span>
                  </li>
                  <li>
