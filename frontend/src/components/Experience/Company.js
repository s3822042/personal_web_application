...
const HeadingTitle = tw.h2`text-4xl font-bold text-center text-gray-800 mb-8`;
...
const Image = styled.div((props) => [
  ...
  tw`flex-shrink-0 mx-4 bg-center bg-cover rounded md:w-1/2 lg:w-5/12 xl:w-1/3 h-80 md:h-96 sm:mx-8 md:mx-4 lg:mx-8`,
]);
...
function Company() {
  const cards = [
    {
      imageSrc: require("../../assets/work/fiverr.png").default,
      subtitle: "Fiverr , Behance",
    ...
    <Container>
      <SingleColumn>
        <HeadingInfoContainer>
          <HeadingTitle>Role</HeadingTitle>
          <HeadingDescription>I . am . software . developer</HeadingDescription>
        </HeadingInfoContainer>
          ...
          {cards.map((card, i) => (
            <Card key={i} reversed={i % 2 === 1}>
              ...
              <Details>
                ...
                <Link href={card.url}>More details</Link>
              </Details>
            </Card>
          ))}
        </Content>
